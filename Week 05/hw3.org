...
* Unsynchronized implementation
  ...
  #+BEGIN_SRC sh :result output
    cd files/executables;
    echo -n "01 "; java UnsafeMemory Unsynchronized 1 1000000 6 5 6 3 0 3
    echo -n "02 "; java UnsafeMemory Unsynchronized 2 1000000 6 5 6 3 0 3
    echo -n "04 "; java UnsafeMemory Unsynchronized 4 1000000 6 5 6 3 0 3
    echo -n "08 "; java UnsafeMemory Unsynchronized 8 1000000 6 5 6 3 0 3
    echo -n "16 "; java UnsafeMemory Unsynchronized 16 1000000 6 5 6 3 0 3
    echo -n "32 "; java UnsafeMemory Unsynchronized 32 1000000 6 5 6 3 0 3
#+END_SRC

  #+RESULTS:
  |  1 | Threads | average |  51.242 | ns/transition |
  |  2 | Threads | average | 130.572 | ns/transition |
  |  4 | Threads | average | 341.009 | ns/transition |
  |  8 | Threads | average | 724.541 | ns/transition |
  | 16 | Threads | average | 1408.67 | ns/transition |
  | 32 | Threads | average |  2642.2 | ns/transition |
